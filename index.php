      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            ...
            <p>We have more than a thousand cars for you to choose which you like most. </p>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>We will provide many great features to this car rental system. We are providing the car from 1 hour and upto 24 hours. As we plans to evolve & you move along your day, you can add and remove stops. Also, you can add upto 5 stops at once. And move around town all day without worrying about finding parking spots or driving in traffic. Hop in and hop off as you need. Any time you can decide to rent a car for a few hours of the day, book on the car rental wesite and ride away all day.</p>
    </div>
    <div class="row"> 
